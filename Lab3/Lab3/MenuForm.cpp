...
Lab3::MenuForm::MenuForm(void)
{
	InitializeComponent();
}

Lab3::Circles::Circles(void)
{
	InitializeComponent();
...
Lab3::Quadrangles::Quadrangles(void)
{
	InitializeComponent();
...
Lab3::Rectangles::Rectangles(void)
{
	InitializeComponent();
...
Lab3::Trapezoids::Trapezoids(void)
{
	InitializeComponent();
...
System::Void Lab3::Circles::createRandomCircleToolStripMenuItem_Click(System::Object^ sender, System::EventArgs^ e)
{
	srand(time(NULL));
...
System::Void Lab3::Ellipses::createRandomEllipseToolStripMenuItem_Click(System::Object^ sender, System::EventArgs^ e)
{
	srand(time(NULL));
	/*bool flag = true;
	int fault;
...
System::Void Lab3::Quadrangles::createRandomQuadrangeleToolStripMenuItem_Click(System::Object^ sender, System::EventArgs^ e)
{
	srand(time(NULL));
...
System::Void Lab3::Rectangles::createRandomRectangleToolStripMenuItem_Click(System::Object^ sender, System::EventArgs^ e)
{
	int fault;
	int massx[30] = { 50, 100, 150, 200 ,250 ,300 ,350, 400 ,450 , 500 ,550, 600, 650, 700, 750, 800,
	850, 900, 950, 1000, 1050, 1100,1150 ,1200, 1250, 1300, 1350, 1400, 1450, 1500 };
...
System::Void Lab3::Rhombs::createRandomRhombToolStripMenuItem_Click(System::Object^ sender, System::EventArgs^ e)
{
	int fault;
	int massx[30] = { 50, 100, 150, 200 ,250 ,300 ,350, 400 ,450 , 500 ,550, 600, 650, 700, 750, 800,
	850, 900, 950, 1000, 1050, 1100,1150 ,1200, 1250, 1300, 1350, 1400, 1450, 1500 };
...
System::Void Lab3::Trapezoids::createRandomTrapezoidToolStripMenuItem_Click(System::Object^ sender, System::EventArgs^ e)
{
	int fault;
	int massx[30] = { 50, 100, 150, 200 ,250 ,300 ,350, 400 ,450 , 500 ,550, 600, 650, 700, 750, 800,
	850, 900, 950, 1000, 1050, 1100,1150 ,1200, 1250, 1300, 1350, 1400, 1450, 1500 };
...
System::Void Lab3::MenuForm::CirBut_Click(System::Object^ sender, System::EventArgs^ e)
{
	Circles^ f2 = gcnew Circles();
	f2->Show();
}

System::Void Lab3::MenuForm::ElBut_Click(System::Object^ sender, System::EventArgs^ e)
{
	Ellipses^ f2 = gcnew Ellipses();
	f2->Show();
}

System::Void Lab3::MenuForm::QuaBut_Click(System::Object^ sender, System::EventArgs^ e)
{
	Quadrangles^ f2 = gcnew Quadrangles();
	f2->Show();
}

System::Void Lab3::MenuForm::RecBut_Click(System::Object^ sender, System::EventArgs^ e)
{
	Rectangles^ f2 = gcnew Rectangles();
	f2->Show();
}

System::Void Lab3::MenuForm::RhBut_Click(System::Object^ sender, System::EventArgs^ e)
{
	Rhombs^ f2 = gcnew Rhombs();
	f2->Show();
}

System::Void Lab3::MenuForm::TrapBut_Click(System::Object^ sender, System::EventArgs^ e)
{
	Trapezoids^ f2 = gcnew Trapezoids();
	f2->Show();
}

System::Void Lab3::Circles::CirMove_Click_1(System::Object^ sender, System::EventArgs^ e)
{
	if (NumberCir->Value == 0)
	{
		...
		for (int j = 0; j < ic; j++)
		{
			circles[j].MoveTo(Convert::ToInt16(CXoffcet->Value), Convert::ToInt16(CYoffset->Value));
	...
	{
		canvas1->Clear(Color::FromArgb(145, 225, 86));
		circles[Convert::ToInt16(NumberCir->Value) - 1].MoveTo(Convert::ToInt16(CXoffcet->Value), Convert::ToInt16(CYoffset->Value));
		for (int j = 0; j < ic; j++)
		{
			circles[j].Show(canvas1);
		}
...
System::Void Lab3::Circles::DelCir_Click(System::Object^ sender, System::EventArgs^ e)
{
...
System::Void Lab3::Circles::ResCir_Click(System::Object^ sender, System::EventArgs^ e)
{
	int R1;
	srand(time(NULL));
	if (NumberCir->Value == 0)
...
System::Void Lab3::Ellipses::EllMove_Click(System::Object^ sender, System::EventArgs^ e)
{
	if (NumberEll->Value == 0)
	{
		...
		for (int j = 0; j < ie; j++)
		{
			ellipses[j].MoveTo(Convert::ToInt16(EllXoffcet->Value), Convert::ToInt16(EllYoffset->Value));
	...
	{
		canvas2->Clear(Color::FromArgb(145, 225, 86));
		ellipses[Convert::ToInt16(NumberEll->Value) - 1].MoveTo(Convert::ToInt16(EllXoffcet->Value), Convert::ToInt16(EllYoffset->Value));
		for (int j = 0; j < ie; j++)
		{
			ellipses[j].Show(canvas2);
		}
...
System::Void Lab3::Ellipses::DelEll_Click(System::Object^ sender, System::EventArgs^ e)
{
...
System::Void Lab3::Ellipses::TurnEll_Click(System::Object^ sender, System::EventArgs^ e)
{
	if (NumberEll->Value == 0)
	{
		canvas2->Clear(Color::FromArgb(145, 225, 86));
...
System::Void Lab3::Quadrangles::QuadrMove_Click(System::Object^ sender, System::EventArgs^ e)
{
	if (NumberQ->Value == 0)
	{
...
System::Void Lab3::Quadrangles::DelQuadr_Click(System::Object^ sender, System::EventArgs^ e)
{
...
System::Void Lab3::Quadrangles::ResQuadr_Click(System::Object^ sender, System::EventArgs^ e)
{
	/*int x1, y1;
	srand(time(NULL));
	if (NumberQ->Value == 0)
	...
	{
		canvas3->Clear(Color::FromArgb(145, 225, 86));
		quadrangles[Convert::ToInt16(NumberQ->Value) - 1].TurnOn90();
		for (int j = 0; j < iq; j++)
		{
			quadrangles[j].Show(canvas3);
		}
...
System::Void Lab3::Rectangles::MoveRec_Click(System::Object^ sender, System::EventArgs^ e)
{
...
System::Void Lab3::Rectangles::DelRect_Click(System::Object^ sender, System::EventArgs^ e)
{
...
System::Void Lab3::Rectangles::TurnRect_Click(System::Object^ sender, System::EventArgs^ e)
{
	if (NumberRect->Value == 0)
	{
		canvas4->Clear(Color::FromArgb(145, 225, 86));
...
System::Void Lab3::Rhombs::MoveRhomb_Click(System::Object^ sender, System::EventArgs^ e)
{
...
System::Void Lab3::Rhombs::DelRhomb_Click(System::Object^ sender, System::EventArgs^ e)
{
...
System::Void Lab3::Rhombs::TurnRhomb_Click(System::Object^ sender, System::EventArgs^ e)
{
	if (NumberRhomb->Value == 0)
	{
		canvas5->Clear(Color::FromArgb(145, 225, 86));
...
System::Void Lab3::Trapezoids::MoveTrap_Click(System::Object^ sender, System::EventArgs^ e)
{
...
System::Void Lab3::Trapezoids::DelTrap_Click(System::Object^ sender, System::EventArgs^ e)
{
...
System::Void Lab3::Trapezoids::ResTrap_Click(System::Object^ sender, System::EventArgs^ e)
{
	/*int x1, y1;
	srand(time(NULL));
	if (NumberTrap->Value == 0)
	...
	{
		canvas6->Clear(Color::FromArgb(145, 225, 86));
		trapezoids[Convert::ToInt16(NumberTrap->Value) - 1].TurnOn90();
		for (int j = 0; j < itr; j++)
		{
			trapezoids[j].Show(canvas6);
		}
