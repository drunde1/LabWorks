...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->pictureBox1->Location = System::Drawing::Point(2, 25);
			this->pictureBox1->Name = L"pictureBox1";
			this->pictureBox1->Size = System::Drawing::Size(2048, 792);
			this->pictureBox1->TabIndex = 15;
			this->pictureBox1->TabStop = false;
			this->pictureBox1->Click += gcnew System::EventHandler(this, &Objects::pictureBox1_Click);
			// 
			// menuStrip1
			// 
			...
			this->createCurcleToolStripMenuItem->Text = L"Create Random Ellips";
			...
			this->RectPar->Location = System::Drawing::Point(2, 826);
			this->RectPar->Name = L"RectPar";
			this->RectPar->Size = System::Drawing::Size(670, 135);
			this->RectPar->TabIndex = 17;
			...
			this->groupBox2->Location = System::Drawing::Point(678, 826);
			...
			this->groupBox3->Location = System::Drawing::Point(1354, 826);
